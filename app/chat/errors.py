...
_USER_MESSAGES: Final[dict[str, str]] = {
    ...
    "rate_limited": ("Забагато запитів до сервісу ШІ. Зачекайте хвилину та спробуйте ще раз."),
    "upstream_5xx": ("Сервіс ШІ тимчасово недоступний. Спробуйте ще раз за кілька хвилин."),
    "timeout": (
