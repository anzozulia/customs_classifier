...
_NOT_FUNCTIONS = {
    "local", "return", "echo", "exit", "shift", "set", "readonly", "declare", "if", "then",
    "else", "elif", "fi", "for", "while", "do", "done", "case", "esac", "cd", "source",
    "trap", "printf", "sleep", "rm", "mkdir", "chmod", "ln", "mv", "cp", "cat", "grep",
    "sed", "awk", "test", "eval", "export", "unset", "wait", "true", "false", "docker",
    "curl", "timeout", "command", "date", "tr", "head", "tail", "sort", "uniq", "wc",
    "touch", "flock", "exec", "read", "continue", "break", "umask", "id", "hostname",
}
